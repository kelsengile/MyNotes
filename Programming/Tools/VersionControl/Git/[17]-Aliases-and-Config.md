[Previous](./%5B16%5D-Blame-and-Bisect.md) | [Table of Contents](./[0]-Introduction-to-Git.md) | [Next](./[18]-Pull-Requests.md)

# Lesson 17 - Aliases And Configuration

## 17.1 Configuration Recap

As covered in [Installing Git & First-Time Setup](./%5B1%5D-Installation-and-Setup.md), Git config exists at three levels:
