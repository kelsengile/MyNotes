# [16] Optimizing Install Size & Build Performance
...
## Excluding Files From Published Packages
...
Run an unused-dependency checker on a real project, and check your total install size before and after removing anything it flags.

## Series Complete 🎉

You've now covered the full lifecycle of working with packages — from what they are, to installing and managing them, creating and publishing your own, and keeping them secure, license-compliant, and performant. Head back to the [Introduction](./%5B0%5D-Introduction.md) to review the full Table of Contents.

---
⬅ [15] [License Compliance](./%5B15%5D-License-Compliance.md) | ⬆ [0] [Introduction](./%5B0%5D-Introduction.md)
